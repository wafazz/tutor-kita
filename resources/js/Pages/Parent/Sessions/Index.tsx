            ...
            <>
                <div className="mb-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        {['', 'scheduled', 'completed', 'checked_in'].map((s) => (
                            <Link
                                key={s}
                                href={route('parent.sessions.index', s ? { status: s } : {})}
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {sessions.data.map((session) => (
                                <tr key={session.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{session.start_time ?? '-'}</td>
                            ...
                            {sessions.data.length === 0 && (
                                <tr>
                                    <td colSpan={8} className="px-6 py-4 text-center text-sm text-gray-500">No sessions found.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>

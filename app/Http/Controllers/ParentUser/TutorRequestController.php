...
class TutorRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'preferred_area' => 'nullable|required_if:preferred_location,home|string|max:255',
            'preferred_location' => 'required|in:home,online',
            'preferred_schedule' => 'nullable|string|max:255',
            'preferred_time' => 'required|string|max:255',
            'preferred_tutor_gender' => 'required|in:male,female,both',
        ...
        $baseData = [
            ...
            'preferred_tutor_gender' => $validated['preferred_tutor_gender'],

...
class SettingController extends Controller
{
    public function index()
    {
        return Inertia::render('Admin/Settings/Index', [
            'settings' => [
                ...
                'acceptance_expiry_hours' => Setting::get('acceptance_expiry_hours', '24'),
                'payment_expiry_hours' => Setting::get('payment_expiry_hours', '48'),
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'acceptance_expiry_hours' => 'required|integer|min:1|max:720',
            'payment_expiry_hours' => 'required|integer|min:1|max:720',

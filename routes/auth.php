...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/tutor', [RegisteredUserController::class, 'createTutor'])
        ->name('register.tutor');

    Route::post('register/tutor', [RegisteredUserController::class, 'storeTutor'])
        ->name('register.tutor.store');
